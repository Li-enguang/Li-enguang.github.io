...
&#160;&#160;&#160;&#160;主题配置文件在主目录下的`_config.yml`，请根据自己需要修改使用。下面是我的配置
...
# subNav-子导航
subNav:
  - github: "https://github.com/Li-enguang/"
  # - github: "#" # (支持设置多个)
  # - gitee: "#" # 码云
  # - jianshu: "#" #简书
  # - cnblog: "#"
  # - blog: "#"
  - csdn: "https://blog.csdn.net/weixin_51582527"
  # - rss: "#"
  # - zhihu: "#"
  - qq: "img/qq.png"
...
music:
  ...
  # 播放器尺寸类型(1：长尺寸、2：短尺寸)
  type: 2
  id: 427606780  # 网易云分享的音乐ID(更换音乐请更改此配置项)
...
github:
  # (关闭请设置为false)
  url: https://github.com/Li-enguang/

# 页脚 Litten(此配置项已弃用)
# 帮助我们让更多人可以更方便使用Hexo，请尽量不要修改此主题配置
pageFooter:
  litten: GitHub:<a href="https://github.com/Li-enguang" target="_blank">theme-yilia</a>
...
tab_title_change:
  enable: true
  left_tab_title: '切走干嘛ya~ '
  return_tab_title: '又回来la~ '
...
friends:
  ...
  GitHub:
    url: https://github.com/Li-enguang/
  CSDN:
    url: https://blog.csdn.net/weixin_51582527
# 关于我
aboutme: 主要涉及技术：<br>后端开发方向<br>Linux<br>C++<br>MySQL<br><br>QQ:1906438581<br>微信:17634107762<br>有任何疑问可以和我探讨呀<br><br>文章陆续更新中<br>热爱技术<br>热爱生活<br>谢谢阅读
